...
public class AdminStaffMailServiceImpl implements AdminStaffMailService {
    ...
    public void sendMailCreateStaff(NhanVien staff) {
                        ...
                        <html>
                            <body style="font-family: Arial, sans-serif; line-height: 1.6;">
                                <div style="max-width: 600px; margin: 0 auto; border: 1px solid #ddd; border-radius: 8px; padding: 20px; background-color: #f9f9f9;">
                                    ...
                                    <p style="margin-top: 20px;"> 1: Không cung cấp bất kỳ thông tin nào về thông tin đăng nhập của hệ thống cho bất kỳ ai (Nếu có cung cấp gây ảnh hưởng đến công ty vui lòng chịu toàn bộ trách nhiệm)</strong></p>
                                    <p style="margin-top: 20px;"> 2: Đọc kỹ hướng dẫn sử dụng hệ thống trong tài liệu</strong></p>
        ...
        log.info("sendMail: {}", staff.getEmail());
    ...
    @Override
    public void sendMailUpdateStaff(NhanVien staff) {
        String emailContent = String.format("""
                        <html>
                            <body style="font-family: Arial, sans-serif; line-height: 1.6;">
                                <div style="max-width: 600px; margin: 0 auto; border: 1px solid #ddd; border-radius: 8px; padding: 20px; background-color: #f9f9f9;">
                                    <h2 style="text-align: center; color: #4CAF50;">Thông Báo Cập Nhật Thông Tin Nhân Viên</h2>
                                    <p>Xin chào <strong>%s</strong>,</p>
                                    <p>Bạn đã được tạo tài khoản trên hệ thống <strong>TShirtsTwo</strong>. Dưới đây là thông tin tài khoản của bạn:</p>
                                    <table style="width: 100%%; border-collapse: collapse; margin-top: 10px;">
                                        <tr>
