...
import {FindSizeRequest, PropertySizeParams} from "@/infrastructure/services/api/admin/size.api";
...
const params = ref<PropertySizeParams>({
  page: 1,
  keyword: null
})
...
function onChangeFilter(key: keyof FindSizeRequest, value: any) {
  params.value[key] = value;
  debouncedEmit();
}

function onChangeInput(key: keyof FindSizeRequest, e: any) {
