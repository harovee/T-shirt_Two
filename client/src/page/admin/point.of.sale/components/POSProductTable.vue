<template>
    ...
    <template #bodyCell="{ record, column }">
          <a-image-preview-group>
              ...
              <div v-else-if="column.key === 'hanhDong'" class="flex items-center justify-center space-x-2">
  ...
  import { FindPOSProductDetailRequest, POSProductDetailResponse } from "@/infrastructure/services/api/admin/point-of-sale.api";
