import { Ref } from "vue";
import { BillRequest, FindBillRequest, getBillById, getBills, updateBill, getBillsWait, BillCreateRequest, createBillsWait, removeBillWait } from "../../api/admin/bill.api";
